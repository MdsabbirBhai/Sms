...
<html>
    <head>
        ...
        <title>Online Ludo Game -- PHP Fortress</title>
        <style> 
    ...
    if(winner.color == "red")
    {
      if(r1.isReachedDestination && r2.isReachedDestination && r3.isReachedDestination  && r4.isReachedDestination) { document.getElementById("finalnote").style.display = "block";
        ...
        if((y1.isReachedDestination && y2.isReachedDestination && y3.isReachedDestination  && y4.isReachedDestination) || redAutoExit) {
         document.getElementById("finalnotep").innerHTML = "PHP Fortress Bot Won"; document.getElementById("finalnote").style.display = "block";
      }
    }
}
...
arrgetbtn.push({"title":"PHP Fortress","icon":"fwidgethelp-telegram_v2","link":"https://telegram.dog/PHPs_FortressOfficial","target":"_blank","color":"#ffffff","background":"rgb(39, 165, 231)"});
 var WidGetButtonOptions = {
  id:"4b6927c0bcf610aab29c4c3629bb2a1f",
  iconopen:"fwidgethelp-level-up",
  maintitle:"Php Fortress",
